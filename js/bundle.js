...
function cards() {
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formsSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])('.modal', modalTimerId);
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["closeModal"])();
    }, 4000);
  }
}
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return Object(_modules_modal__WEBPACK_IMPORTED_MODULE_5__["openModal"])('.modal', modalTimerId);
  }, 20000);
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2020-10-23');
